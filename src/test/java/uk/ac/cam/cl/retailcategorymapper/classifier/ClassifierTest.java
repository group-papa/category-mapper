...
public class ClassifierTest {
    private static NaiveBayesClassifier nbc1 = new NaiveBayesClassifier(null);
    private static NaiveBayesClassifier nbc2 = new NaiveBayesClassifier(null);
    private static NaiveBayesClassifier nbc3 = new NaiveBayesClassifier(null);
